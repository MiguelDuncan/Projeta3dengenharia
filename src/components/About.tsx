...
export default function About() {
  return (
    <section id="sobre" className="bg-[#0a0f1e] py-24 relative overflow-hidden">
      {/* Linha decorativa laranja na lateral */}
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <h2 className="text-4xl md:text-5xl font-black text-white leading-tight mb-6">
              Engenharia que <span className="text-[#f97316]">Transforma</span> Ideias em Realidade
            </h2>
          ...
          {/* Lado Direito: Os 4 Pilares Corrigidos para o TypeScript */}
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            
            {/* Pilar 1 */}
            <div className="bg-[#0d1426] border border-[#1a2540] p-6 hover:border-[#f97316]/40 transition-colors duration-300">
              <div className="w-10 h-10 bg-[#f97316]/10 flex items-center justify-center mb-4">
                <Zap size={18} className="text-[#f97316]" />
              </div>
              <h4 className="text-white font-bold text-sm mb-2">Tecnologia de Ponta</h4>
              <p className="text-[#6b7280] text-xs leading-relaxed">Equipamentos de alta precisão e materiais técnicos para resultados superiores em cada projeto.</p>
            </div>
            ...
            <div className="bg-[#0d1426] border border-[#1a2540] p-6 hover:border-[#f97316]/40 transition-colors duration-300">
              ...
              <h4 className="text-white font-bold text-sm mb-2">Engenharia Real</h4>
              <p className="text-[#6b7280] text-xs leading-relaxed">Cada projeto passa por análise técnica rigorosa garantindo peças funcionais e duráveis.</p>
            </div>
            ...
            <div className="bg-[#0d1426] border border-[#1a2540] p-6 hover:border-[#f97316]/40 transition-colors duration-300">
              ...
              <h4 className="text-white font-bold text-sm mb-2">Qualidade Certificada</h4>
              <p className="text-[#6b7280] text-xs leading-relaxed">Processos controlados e controle dimensional em cada peça entregue ao cliente.</p>
            </div>
            ...
            <div className="bg-[#0d1426] border border-[#1a2540] p-6 hover:border-[#f97316]/40 transition-colors duration-300">
              ...
              <h4 className="text-white font-bold text-sm mb-2">Juiz de Fora — MG</h4>
              <p className="text-[#6b7280] text-xs leading-relaxed">Atendemos clientes em toda a região com entregas rápidas e suporte técnico presencial.</p>
            </div>

          </div>
        </div>

        {/* Linha de Processo Base */}
